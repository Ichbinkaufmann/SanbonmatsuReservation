        ...
        <div class="container">
            <div class="row text-center d-block">
                ...
                <div class="col mt-2 mb-2">
                    <h3 class="news-title">What would you rent?</h3>
                </div>
            </div>
            <div class="container desktop">
                <div class="row justify-content-center mt-4">
                    <div class="col mb-5">
                        <a href="winterequipment.php">
                            <div class="card card-featured rounded-0">
                                <div class="featured-img rounded-0"><img class="rounded-0" src="images/winterequipt.jpg"
                                        alt="winter equipment" /></div>
                                <div class="featured-text">
                                    <h2 class="card-text text-light text-center">Winter Equipment</h2>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col mb-5">
                        <a href="ebike.php">
                            <div class="card card-featured rounded-0">
                                <div class="featured-img rounded-0"><img class="rounded-0" src="images/ebike.jpg"
                                        alt="E-Bike" /></div>
                                <div class="featured-text">
                                    <h2 class="card-text text-light text-center">E-Bike</h2>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="row justify-content-center mt-4">
                            ...
                            <a href="winterequipment.php">
                                <div class="card card-featured-mobile rounded-0">
                                    <div class="featured-img-mobile rounded-0"><img class="rounded-0"
                                            src="images/winterequipt.jpg" alt="winter equipment" /></div>
                                    <div class="featured-text">
                                        <h2 class="card-text text-light text-center">Winter Equipment</h2>
                                    </div>
                                </div>
                        ...
                        <div class="col mb-2">
                            <a href="ebike.php">
                                <div class="card card-featured-mobile rounded-0">
                                    <div class="featured-img-mobile rounded-0"><img class="rounded-0"
                                            src="images/ebike.jpg" alt="E-Bike" /></div>
                                    <div class="featured-text">
                                        <h2 class="card-text text-light text-center">E-Bike</h2>
                                    </div>
                                </div>
