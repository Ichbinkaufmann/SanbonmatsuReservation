...
<?php include 'db_conn.php';
            if(isset($_POST['submit'])){
                ...
                $sql = "INSERT into item (item_name,item_stock,item_img,category,subcategory,item_price,additional_info,item_note) values('$nameItem','$stockItem','$picItem','$categoryItem','$typeItem','$priceItem','$infoItem','$noteItem')";
...
<head>
    <title>Restaurant Services Management</title>
...
<body>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="winterequipment.php">Winter Equipment
                                                Rental</a></li>
                                        <li><a class="dropdown-item active" aria-current="page" href="#">Restaurant</a>
                                        </li>
    ...
    <div class="container mt-5 text-center">
        ...
        <div class="row mb-4">
            <div class="card card_data mt-1 mb-1 " style="width:100%; min-height:520px">
                <div class="card-body">
                    <h5 class="card-title">Restaurant Table</h5>
                    <table class="table mb-3 text-start">
                        ...
                        <?php
                            $result = $database->getRestaurantTable();
                            while ($row = mysqli_fetch_assoc($result)){
                            componentDataRestaurant($row['item_name'],$row['item_img'], $row['subcategory'], $row['item_stock'],$row['item_price'], $row['additional_info'], $row['item_note'], $row['item_id']);
                            }
                            ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalAddLabel">Add more Restaurant Service</h1>
                    ...
                    <div class="modal-body">
                        <div class="row d-flex">
                            ...
                            <div class="col mb-3">
                                ...
                                <input type="text" class="form-control" id="typeItem" aria-describedby="typeItem"
                                    name="typeItem" autocomplete="off" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control d-none" id="categoryItem"
                                    aria-describedby="categoryItem" name="categoryItem" value="Restaurant">
                            </div>
                        </div>
                        <div class="row d-flex">
                            <div class="col mb-3">
