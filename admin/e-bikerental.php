...
<?php include 'db_conn.php';
            if(isset($_POST['submit'])){
                ...
                if($result){
                    ...
                    window.location.href='e-bikerental.php';
                    </script>";
                }else{
...
<head>
    <title>E-bike Rental Services Management</title>
                            ...
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item active" aria-current="page" href="#">E-bike
                                                Rental</a></li>
    ...
    <div class="container mt-5 text-center">
        ...
        <div class="row mb-4">
            <div class="card card_data mt-1 mb-1 " style="width:100%; min-height:440px">
                <div class="card-body">
                    <h5 class="card-title">E-Bike Table</h5>
                    <table class="table mb-3 text-start">
                        ...
                        <?php
                            $result = $database->getEbikeTable();
                            while ($row = mysqli_fetch_assoc($result)){
                            componentDataEbike($row['item_name'],$row['item_img'], $row['subcategory'], $row['item_stock'],$row['item_price'], $row['additional_info'], $row['item_note'], $row['item_id']);
                            }
                            ?>
                        ...
                        <div class="row d-flex">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control d-none" id="categoryItem"
                                    aria-describedby="categoryItem" name="categoryItem" value="E-Bike">
                            </div>
                            <div class="row d-flex">
                                <div class="col mb-3">
