    ...
    <div class="container mt-5 text-center">
        <div class="row d-flex">
            ...
            <div class="col-6 mt-4">
                <h2>Hiking Services Management</h2>
            </div>
        ...
        <div class="row mb-4">
            <div class="card card_data mt-1 mb-1 " style="width:100%; min-height:440px">
                <div class="card-body">
                    <h5 class="card-title">Hiking Table</h5>
                    <table class="table mb-3 text-start">
                        ...
                        <div id="data"> <?php
                            $result = $database->getHikingTable();
                            while ($row = mysqli_fetch_assoc($result)){
                            componentDataHiking($row['item_name'], $row['subcategory'], $row['item_stock'],$row['item_price'], $row['additional_info'], $row['item_note'], $row['item_id']);
                            }
                            ?></div>
                    </table>
                </div>
