...
<?php '../db_conn.php';
 ...
 $item_note = $row['item_note'];
         ...
         if(isset($_POST['submit'])){
             ...
             $sql = "UPDATE item set item_id=$id,item_name='$nameItem',item_img='$picItem', item_stock=$stockItem,category='$categoryItem',subcategory='$typeItem', rent_type='$rentType',item_price=$priceItem,additional_info='$infoItem',item_note='$noteItem' WHERE item_id =$id";
...
<head>
    <title>Edit E-Bike Management</title>
...
<body>
    ...
    <div class="container mt-5 text-center">
        <div class="row d-flex">
            <div class="col">
                <h2>Edit Winter Equipment Rental Service</h2>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col">
                <form method="post">
                    <div class="row d-flex">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control d-none" id="categoryItem"
                                aria-describedby="categoryItem" name="categoryItem" value="Winter Activity Equipment">
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="infoItem" name="infoItem"
                            autocomplete="off"><?php echo $additional_info?></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="noteItem" class="form-label">Note</label>
                        <textarea class="form-control" id="noteItem" autocomplete="off"
                            name="noteItem"><?php echo $item_note?></textarea>
                    </div>
                    <div class="col">
                        <button type="button" class="btn btn-secondary"><a class="text-white"
                                href="../winterequipment.php">Cancel</a>
                        </button>
