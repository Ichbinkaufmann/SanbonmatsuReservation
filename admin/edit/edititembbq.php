...
<head>
    <title>Edit Nikko Craft Beer BBQ Management</title>
...
<body>
    ...
    <div class="container mt-5 ">
        <div class="row d-flex">
            <div class="col">
                <h2 class="text-center">Edit Nikko Craft Beer Service</h2>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col">
                <form method="post">
                    <div class="row d-flex">
                        ...
                        <div class="mb-3">
                            <label for="nameItem" class="form-label d-none">Type</label>
                            <input type="text" class="form-control d-none" id="typeItem" aria-describedby="typeItem"
                    ...
                    <div class="col">
                        <button type="button" class="btn btn-secondary"><a class="text-white"
                                href="../nikkobrewingbbq.php">Cancel</a>
                        </button>
