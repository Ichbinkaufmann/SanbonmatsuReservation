...
<?php '../db_conn.php';
 ...
 $item_note = $row['item_note'];
         ...
         if(isset($_POST['submit'])){
             ...
             $sql = "UPDATE item set item_id=$id,item_name='$nameItem',item_img='$picItem', item_stock=$stockItem,category='$categoryItem',subcategory='$typeItem',item_price=$priceItem,additional_info='$infoItem',item_note='$noteItem' WHERE item_id =$id";
     
             $result=mysqli_query($conn,$sql);
             if($result){
                echo "<script>
                alert('Item Edited successfully');
                window.location.href='../brewcraftbeer.php';
                </script>";
...
<head>
    <title>Edit Brew Craft Beer Management</title>
...
<body>
    ...
    <div class="container mt-5 text-center">
        <div class="row d-flex">
            <div class="col">
                <h2>Edit Brew Craft Beer Service</h2>
            </div>
        </div>
        <div class="row mb-4">
            <div class="col">
                <form method="post">
                    <div class="row d-flex">
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control" id="typeItem" aria-describedby="typeItem"
                                name="typeItem" autocomplete="off" value="<?php echo $subcategory?>" required>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="col">
                        <button type="button" class="btn btn-secondary"><a class="text-white"
                                href="../brewcraftbeer.php">Cancel</a>
                        </button>
