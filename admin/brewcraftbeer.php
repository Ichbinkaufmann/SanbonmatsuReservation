...
<?php include 'db_conn.php';
            if(isset($_POST['submit'])){
                ...
                $sql = "INSERT into item (item_name,item_stock,category,subcategory,item_price,additional_info,item_note) values('$nameItem','$stockItem','$categoryItem','$typeItem','$priceItem','$infoItem','$noteItem')";
...
<head>
    <title>Brew Craft Beer Services Management</title>
...
<body>
                            ...
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item active" aria-current="page" href="#">Brew Craft Beer
                                                Experience</a>
                                        </li>
                                        <li><a class="dropdown-item" href="e-bikerental.php">E-bike Rental</a></li>
                                        <li><a class="dropdown-item" href="winterequipment.php">Winter
                                                Equipment
                                                Rental</a></li>
    ...
    <div class="container mt-5">
        <div class="row d-flex">
            <div class="col-3 mt-5 mb-1">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                    data-bs-target="#modalAdd">Add</button>
            </div>
            <div class="col-6 mt-4 text-center">
                <h2>Brew Craft Beer Services Management</h2>
            </div>
        ...
        <div class="row">
            <div class="card card_data mt-1 mb-3" style="width:100%; min-height:520px;">
                <div class="card-body">
                    <h5 class="card-title text-center">Brew Craft Beer Table</h5>
                    <table class="table mb-3 text-start">
                        ...
                        <?php
                        $result = $database->getBrewexTable();
                        while ($row = mysqli_fetch_assoc($result)){
                            componentDataBrewex($row['item_name'], $row['subcategory'], $row['item_stock'],$row['item_price'], $row['additional_info'], $row['item_note'],$row['item_id']);
                        }
                    ?>
                    </table>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalAddLabel">Add more hiking service</h1>
                    ...
                    <div class="modal-body">
                        <div class="row d-flex">
                            ...
                            <div class="col mb-3">
                                ...
                                <select class="form-select" id="typeItem" aria-label="Select Hiking Type"
                                    name="typeItem" required>
                                    <option value="Beer Brewing Experience" selected>Beer Brewing Experience</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label for="categoryItem" class="form-label d-none">Category</label>
                                <input type="text" class="form-control d-none" id="categoryItem"
                                    aria-describedby="categoryItem" name="categoryItem" value="Nikko Craft Beer">
                            </div>
                        </div>
                        <div class="row d-flex">
                            <div class="col mb-3">
