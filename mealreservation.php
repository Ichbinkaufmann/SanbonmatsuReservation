        ...
        <div class="container">
            ...
            <div class="container desktop">
                <div class="row justify-content-center mt-4">
                    <div class="col mb-5">
                        <a href="restaurantreservation.php">
                            <div class="card card-featured rounded-0">
                                <div class="featured-img rounded-0"><img class="rounded-0" src="images/restaurant.jpg"
                                        alt="restaurant" /></div>
                                <div class="featured-text">
                                    <h2 class="text-light text-center card-text">Restaurant</h2>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col mb-5">
                        <a href="nikkocraftbeerbbq.php">
                            <div class="card card-featured rounded-0">
                                <div class="featured-img rounded-0"><img class="rounded-0" src="images/bbq.jpeg"
                                        alt="Nikko BBQ" /></div>
                                <div class="featured-text">
                                    <h2 class="text-light text-center card-text">Nikko Craft Beer BBQ</h2>
                                </div>
                            </div>
                        </a>
                    </div>
            ...
            <div class="container mobile">
                <div class="row justify-content-center mt-4">
                        ...
                        <a href="restaurantreservation.php">
                            <div class="card card-featured-mobile rounded-0">
                                <div class="featured-img-mobile rounded-0"><img class="rounded-0"
                                        src="images/restaurant.jpg" alt="restaurant" /></div>
                                <div class="featured-text">
                                    <h2 class="text-light text-center card-text">Restaurant</h2>
                                </div>
                            </div>
                    ...
                    <div class="col mb-2">
                        <a href="nikkocraftbeerbbq.php">
                            <div class="card card-featured-mobile rounded-0">
                                <div class="featured-img-mobile rounded-0"><img class="rounded-0" src="images/bbq.jpeg"
                                        alt="Nikko BBQ" /></div>
                                <div class="featured-text">
                                    <h2 class="text-light text-center card-text">Nikko Brewing BBQ</h2>
                                </div>
                            </div>
                        </a>
                    </div>
