...
<head>
    ...
    <title>Restaurant Reservation - Sanbonmatsu Chaya</title>
</head>
    ...
    <section id="reservation">
        <div class="container">
            <div class="row text-center mt-2 d-block">
                <div class="col mb-2">
                    <h1 class="news-title">Restaurant at Sanbonmatsu Chaya</h1>
                </div>
            </div>
            <div class="row d-block">
                <?php
                        $result = $database->getDataRestaurant();
                        while ($row = mysqli_fetch_assoc($result)){
                            componentRestaurant($row['item_img'], $row['item_name'], $row['item_price'], $row['additional_info'], $row['item_note'], $row['item_id']);
                        }
                    ?>
            </div>
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu service-options" style="width:270px;">
                                    ...
                                    <li><a class="dropdown-item active" href="#">Restaurant</a>
                                    </li>
                                    <li><a class="dropdown-item" href="#">Nikko Craft Beer BBQ</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
