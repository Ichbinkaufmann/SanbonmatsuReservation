            ...
            echo " 
                    ...
                    <div class=\"card text-center card-notif text-bg-success mb-3\" style=\"max-width: 18rem;\">
                        ...
                        <div class=\"card-body\">
                            ...
                            <a href=\"../../beermakingexp.php\" class=\"btn btn-primary\">OK</a>
                        </div>
                    </div>
                  ";
        }else{
...
<head>
    ...
    <title>Brew Craft Beer reservtaion details</title>
    ...
    <div class="container page-container">
        <div class="row mt-5">
            <div class="col text-center">
                <h2>Brew Craft Beer Reservation</h2>
            </div>
        </div>
        <div class="row mt-2">
            <div class="col ">
                <div class="card card-rervation-terms border-danger mb-3" style="max-width: 90%;">
                    <div class="card-header text-center">Brew Craft Beer Reservation Terms</div>
                    <div class="card-body">
                        <p class="card-text-term">* The event starts at 9:30, so please come before that time.</p>
                        <p class="card-text-term">* 1 Reservation can be attended up to 6 participants.</p>
                        <p class="card-text-term">* We do not accept a reservation for Tuesday.</p>
                        <p class="card-text-term">* Reservations can only be made from 3 to 14 days from the day you are
                            making a reservation.</p>
                        <p class="card-text-term">* Please write all of the participants name on the "Note" form
                            (Maximum 6 person).</p>
                ...
                <div class="card card-cart-form mt-2 mb-4" style="width: 100%; ">
                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="col mb-3">
                                <label for="stockItem" class="form-label d-none">Pick a time</label>
                                <input class="form-control d-none" name="timestart" value="09:30" type="time" required>
                            </div>
                            <div class="row d-flex">
                                <div class="col mb-3">
                                ...
                                <div class="col mb-3">
                                    <label for="stockItem" class="form-label d-none">Quantity</label>
                                    <input class="form-control d-none" name="quantity" value="1" type="number" required>
                                </div>
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="card-body">
                        <a class="text-white" href="../../beermakingexp.php"><button type="button"
