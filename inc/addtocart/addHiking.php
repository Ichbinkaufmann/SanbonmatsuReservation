            ...
            echo " 
                    ...
                    <div class=\"card text-center card-notif text-bg-success mb-3\" style=\"max-width: 18rem;\">
                        ...
                        <div class=\"card-body\">
                            ...
                            <a href=\"../../hiking.php\" class=\"btn btn-primary\">OK</a>
                        </div>
                    </div>
                  ";
        }else{
    ...
    <div class="container page-container">
        <div class="row mt-5">
            <div class="col text-center">
                <h2>Hiking Reservation</h2>
            </div>
        </div>
        <div class="row mt-2">
            <div class="col ">
                <div class="card card-rervation-terms border-danger mb-3" style="max-width: 90%;">
                    <div class="card-header text-center">Hiking Reservation Terms</div>
                    <div class="card-body">
                        <p class="card-text-term">* Type: Personal, for group rate number 2 and 3 only available until
                            17:00.</p>
                        <p class="card-text-term">* Type: Personal, for group rate number 1, 2 and 3 the minimum
                            duration is 2 hours.</p>
                        <p class="card-text-term">* Type: Student, for group rate number 2 and 3 only available until
                            17:00.</p>
                        <p class="card-text-term">* Type: Student, for group rate number 1, 2 and 3 the minimum
                            duration is 2 hours..</p>
                ...
                <div class="card card-cart-form mt-2 mb-4" style="width: 100%; ">
                    ...
                    <div class="card-body">
                        <form method="POST">
                            ...
                            <div class="row d-flex">
                                <div class="col mb-3">
                                    <label for="stockItem" class="form-label">Duration (Hour)</label>
                    ...
                    <div class="card-body">
                        <a class="text-white" href="../../hiking.php"><button type="button"
