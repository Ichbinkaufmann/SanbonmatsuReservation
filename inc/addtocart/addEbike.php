            ...
            echo " 
                    ...
                    <div class=\"card text-center card-notif text-bg-success mb-3\" style=\"max-width: 18rem;\">
                        ...
                        <div class=\"card-body\">
                            ...
                            <a href=\"../../ebike.php\" class=\"btn btn-primary\">OK</a>
                        </div>
                    </div>
                  ";
        }else{
        ...
        <div class="row mt-2">
            <div class="col ">
                <div class="card card-rervation-terms border-danger mb-3" style="max-width: 90%;">
                    <div class="card-header text-center">E-Bike Rental Reservation Terms</div>
                    <div class="card-body">
                        <p class="card-text-term">* Please make sure you picked the correct E-bike for your planned
                            activity.</p>
                        <p class="card-text-term">* By renting our E-Bike you are automatically agree to our return
                            policies.</p>
        ...
        <div class="row">
            <div class="col">
                <div class="card card-cart-form mt-2 mb-4" style="width: 100%; ">
                    ...
                    <div class="card-body">
                        <a class="text-white" href="../../ebike.php"><button type="button"
