            ...
            echo " 
                    ...
                    <div class=\"card text-center card-notif text-bg-success mb-3\" style=\"max-width: 18rem;\">
                        ...
                        <div class=\"card-body\">
                            ...
                            <a href=\"../../nikkocraftbeerbbq.php\" class=\"btn btn-primary\">OK</a>
                        </div>
                    </div>
                  ";
        }else{
...
<head>
    ...
    <title>Nikko Craft Beer BBQ reservtaion details</title>
    ...
    <div class="container page-container">
        <div class="row mt-5">
            <div class="col text-center">
                <h2>Nikko Craft Beer BBQ Reservation</h2>
            </div>
        </div>
        <div class="row mt-2">
            <div class="col ">
                <div class="card card-rervation-terms border-danger mb-3" style="max-width: 90%;">
                    <div class="card-header text-center">Nikko Craft Beer BBQ Reservation Terms</div>
                    <div class="card-body">
                        <p class="card-text-term">* Reservation can only be made from 3 to 14 days from the day you are
                            making the reservation.</p>
                        <p class="card-text-term">* For last minute reservation, it's better to do it via telephone.</p>
                        <p class="card-text-term">* Please read and understand of our cancellation Policies.</p>
        ...
        <div class="row">
            <div class="col">
                <div class="card card-cart-form mt-2 mb-4" style="width: 100%; ">
                        ...
                        <form method="POST">
                            ...
                            <div class="row d-flex">
                                <div class="col mb-3">
                                    ...
                                    <input class="form-control d-none" name="duration" type="number" value="1" required>
                                </div>
                                <div class="col mb-3">
                    ...
                    <div class="card-body">
                        <a class="text-white" href="../../nikkocraftbeerbbq.php"><button type="button"
