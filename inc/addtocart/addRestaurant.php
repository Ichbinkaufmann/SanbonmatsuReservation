            ...
            echo " 
                    ...
                    <div class=\"card text-center card-notif text-bg-success mb-3\" style=\"max-width: 18rem;\">
                        ...
                        <div class=\"card-body\">
                            ...
                            <a href=\"../../restaurant.reservation.php\" class=\"btn btn-primary\">OK</a>
                        </div>
                    </div>
                  ";
        }else{
...
<head>
    ...
    <title>Restaurant reservtaion details</title>
        ...
        <div class="row mt-2">
            <div class="col ">
                <div class="card card-rervation-terms border-danger mb-3" style="max-width: 90%;">
                    <div class="card-header text-center">Restaurant Reservation Terms</div>
                    <div class="card-body">
                        <p class="card-text-term">* Please read and understand our cancelation policies before making a
                            reservtaion.</p>
        ...
        <div class="row">
            <div class="col">
                <div class="card card-cart-form mt-2 mb-4" style="width: 100%; ">
                    ...
                    <div class="card-body">
                        <a class="text-white" href="../../restaurantreservation.php"><button type="button"
